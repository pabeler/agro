...
const OrderDetails = () => {
  ...
  const load_data = async () => {
    const { data: orderDetailsList, error: errorOrderDetailsList } = await supabase.from('order_items').select('product_id, quantity, total_price, status, products ( id, image_path, price, product_name )').eq('order_id', orderId)
